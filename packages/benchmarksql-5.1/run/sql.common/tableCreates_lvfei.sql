...
create table bmsql_order_line (
  ...
  constraint pk_order_line PRIMARY KEY (ol_w_id, ol_d_id, ol_o_id, ol_integer)
...
)tablegroup='tpcc_group' use_bloom_filter=true compress BLOCK_SIZE=16384 partition by hash(i_id) partitions 3;
